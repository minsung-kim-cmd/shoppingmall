...
<form method="post" action="idfind.do">
<table><caption><h2 style="color:gray">아이디 찾기</h2></caption>
	<tr><th><input type="text" name="cname" placeholder="이름" required="required" autofocus="autofocus" autocomplete="off"></th></tr>
