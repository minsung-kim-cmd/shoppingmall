...
<table><caption><h2>${customer.cid}님의 회원정보</h2></caption>
	<tr><th>이름</th><td>${customer.cname }</td></tr>
	<tr><th>전화</th><td>${customer.ctel }</td></tr>
	<tr><th rowspan="2">주소</th><td colspan="3">${customer.cpostcode }</td></tr>
	<tr><td style="border-top:0">${customer.caddr} ${customer.cdetailaddr }</td></tr>
	<tr><th>가입일</th><td>${customer.cjoin}</td></tr>
	<tr><th>이메일</th><td>${customer.cemail}</td></tr>
	<tr><th>생년월일</th><td>${customer.cbir}</td></tr>
	<tr><th colspan="2" style="border-right:0">
	<a href="updateForm.do">정보수정 | </a>
	<a href="delete.do">회원탈퇴 | </a>
	<a href="orderList.or">주문조회</a>
	</th>
</table>
