...
<form action="login.do" method="post">
	<table>
	<tr><th colspan="2"><input type="text" name="cid" required="required" autofocus="autofocus" placeholder="아이디" autocomplete="off"></th></tr>
	<tr><th colspan="2"><input type="password" name="cpass" required="required" placeholder="비밀번호"></th></tr>
	<tr><th colspan="2"><input type="submit" value="로그인"></th></tr>
	<tr><td colspan="2">

	<p>
	<a href="idfindForm.do">아이디 찾기 | </a>
	<a href="passfindForm.do">비밀번호 찾기</a>
	</p>
	</td></tr>
</table></form>
