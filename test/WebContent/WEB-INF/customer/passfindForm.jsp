...
<table><caption><h2 style="color:gray">비밀번호 찾기</h2></caption>
	<tr><th><input type="text" name="cid" placeholder="아이디" required="required" autofocus="autofocus" autocomplete="off"></th></tr>
	<tr><th><input type="text" name="cname" placeholder="이름" required="required" autocomplete="off"></th></tr>
	<tr><th><input type="text" name="cbir" placeholder="생년월일" required="required" autocomplete="off"></th></tr>
	<tr><th><input type="submit" value="찾기"></th></tr>
</table></form>
